const newsMenuWorldNewsArticles = [
    {
        ...
        newsMenuWorldNewsArticle: [
            ...
            `It comes after Italian Deputy PM Luigi Di Maio met French 'yellow-vest' protesters near Paris on Tuesday. France warned him not to interfere in the country's politics. Relations between the two countries - both founding members of the EU - have been tense since Italy's populist Five Star Movement and right-wing League party formed a coalition government in June 2018. The two governments have clashed over a range of issues, including immigration.`
        ]
    },
    {
    ...
    },
    {
        ...
        newsMenuWorldNewsArticle: [
            `Saudi Arabia "seriously curtailed" Turkish access to the scene of Jamal Khashoggi's murder, a UN investigator has said.
            ...
            `Mr Khashoggi was last seen alive entering the Saudi consulate in Istanbul on 2 October. The 59-year-old was a prominent critic of Crown Prince Mohammed bin Salman.
            ...
            The journalist who vanished into a consulate Saudi authorities, after denying any knowledge of his whereabouts, later admitted he had been killed, blaming a "rogue agent".
    ...
    },
    {
        ...
        newsMenuWorldNewsArticle: [
            ...
            `Mr Herring had joined calls for Governor Ralph Northam to quit over a racist photo and blackface scandal. The lieutenant governor is meanwhile battling a sex assault claim.`,
            ...
            Behind the legacy of America's blackface 'There's going to be racism until the day we die'`,
        ]
    },
];
