const newsMenuSportsList = [
    {
        ...
        newsMenuSportsArticle: [
            `Rohit Sharma became the highest run-scorer in Twenty20 internationals as India beat New Zealand to level the three-match series at 1-1. The opener, 31, hit 50 off 29 balls as India chased 159 to win by seven wickets with seven balls to spare in Auckland.`,
            `He now has 2,288 runs, surpassing New Zealand's Martin Guptill's 2,272. Rohit, who made his T20 debut for India against England in 2007, averages 32.68 from 92 matches.`,
    ...
    },
    {
        ...
        newsMenuSportsArticle: [
            ...
            `With a total of 586, he is 10th on the list of the most home runs hit in a major league career. Robinson, who holds countless other records, died at home in California. Since his debut, more than half of all teams have had a black manager.`,
            `Born in Beaumont, Texas, in 1935, Robinson got his start in Major League Baseball in 1956 - just nine years after Jackie Robinson broke the colour barrier by joining a professional team. In his first at-bat for Cleveland he hit a home run.`,
            `Over his career, he coached the Baltimore Orioles, the San Francisco Giants and Montreal. Robinson became the first manager of the Washington Nationals after the team relocated from Montreal for the 2005 season.
    ...
    },
    {
        ...
        newsMenuSportsArticle: [
            `Barcelona president Josep Maria Bartomeu says the club's transfer activity is an indication they are preparing for life after Lionel Messi. Barca last month confirmed the £65m signing of 21-year-old midfielder Frenkie de Jong from Ajax.`,
            `Messi, 31, has scored 581 goals in 664 games for Barcelona. "I know one day Lionel will say he's retiring," Bartomeu told the 5 live Football Daily Podcast's Guillem Balague.`,
    ...
    },
    {
        ...
        newsMenuSportsArticle: [
            ...
            `"But then they made it compulsory that you also had to do tap dancing as well, and I was terrible at tap dancing, so I quit that aged four," she explains. She joined a song-and-dance club instead. That lasted two years before she switched to a weekend drama group.`,
            ...
            `"That was a clash with drama, so I had the choice: try athletics or stick with drama. "I quit drama."`,
            `Barely a teenager, already a renaissance woman. Now 20, she is still swapping hats with millennial speed. Over the past 12 months, she has appeared in various guises in an Olympic Stadium, an Edinburgh Festival backroom, on network television and thousands of social media feeds.`,
        ]
    },
    {
        ...
        newsMenuSportsArticle: [
            `Liverpool have announced a world record profit of £106m. In their yearly financial results, the Reds made an annual pre-tax profit of £125m - up from £40m - as turnover increased in the 12 months to May 2018 by £90m to £455m, also a record.`,
            ` Liverpool were boosted financially by a run to the Champions League final last season, which earned an estimated £72m. They were also helped by midfielder Philippe Coutinho's £142m transfer to Barcelona in January 2018.`,
            ...
            `Media revenue has increased by £66m to £220m, commercial revenue by £17m to £154m and match revenue by £7m to £81m. In revenue terms, Liverpool will leapfrog Arsenal into third place in the Premier League, behind Manchester United and Manchester City.`,
            `In total, £137m came into the club from player transfers. Liverpool say all of that has been reinvested back into the squad, taking outgoings on new players to more than £190m. Andy Hughes, the club's chief operating officer, said: "What we have seen is a stable and sustained improvement in the club's financial position over recent years.`,
