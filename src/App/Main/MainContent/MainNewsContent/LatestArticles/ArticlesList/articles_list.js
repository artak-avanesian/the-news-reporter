const articlesList = [
    {
        ...
        art_list_article: [
            `Moravetsky believes that the gas pipeline will untie the hands of Russia's aggression.
    ...
    },
    {
        ...
        art_list_article: [
            `According to French media, six people were injured as a result of the incident. They had to be hospitalized to the hospital, but the lives of the victims did not threaten anything. They were diagnosed with light burns of arms and legs.`,
    ...
    },
    {
        ...
        art_list_article: [
            `Changes should take into account the interests of people of different religions.`,
