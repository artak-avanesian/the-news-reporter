const techNewsBlocks = [
    {
        ...
        article_tech: [
            `This missile should deliver the Signus cargo module to the International Space Station.`,
            `"Antares" was created by the American corporation "Orbital ATK" with the participation of foreign partners, incl. a number of Ukrainian enterprises. Thus, the main design of the first stage of the missile was developed by the Design Bureau Southern and manufactured at the Southern Machine-Building Plant named after Makarov in cooperation with the Ukrainian enterprises Khartron-ARCOS, Khartron-Yukom, RAPID and others.`,
            `Ukrainian experts took an active part in Antares tests conducted in the USA, "Ambassador of Ukraine to the USA Valery Chaly wrote in Facebook.In June 2018, the American company Orbital ATK became a division of Northrop Grumman Inc., one of the most powerful US defense corporations.`
        ],
        author:"John Doe",
        comments:29,
    },
    {
        ...
        article_tech: [
            `Elon Mask said this on his Twitter page.`,
    ...
    },
    {
        ...
        article_tech: [
            `Pages are created using scripts or bots.`,
    ...
    },
    {
        ...
        article_tech: [
            `Microsoft's support team said they knew about the problem and were working on fixing the bug.`,
